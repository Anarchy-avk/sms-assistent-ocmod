...
class ControllerCustomerCustomer extends Controller {
	...
	public function index() {
		$this->load->language('customer/customer_smsassistent');

		$this->document->setTitle($this->language->get('heading_title'));

		$this->load->model('customer/customer_smsassistent');
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('customer/customer_smsassistent', 'token=' . $this->session->data['token'] . $url, true)
		);
